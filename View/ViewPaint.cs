...
namespace _21110603_Paint.View
{
    /// <summary>
    ...
    interface ViewPaint
    {
        ...
        /// <summary>
        /// Thiết lập hình nền cho picturebox
        /// </summary>
        /// <param name="pic">PictureBox cần thay đổi nền</param>
        /// <param name="color">Màu sắc</param>
        void setColor(PictureBox pic, Color color);

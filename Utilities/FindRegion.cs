...
namespace _21110603_Paint.Utilities
{
    public class FindRegion
    {
        ...
        public static void setPointHeadTail(Arc_NDP curve)
        {
            int minX = int.MaxValue, minY = int.MaxValue;
            int maxX = int.MinValue, maxY = int.MinValue;
        ...
        public static void setPointHeadTail(Polygon_NDP polygon)
        {
            int minX = int.MaxValue, minY = int.MaxValue;
            int maxX = int.MinValue, maxY = int.MinValue;
        ...
        public static void setPointHeadTail(Pen_NDP pen)
        {
            int minX = int.MaxValue, minY = int.MaxValue;
            int maxX = int.MinValue, maxY = int.MinValue;
